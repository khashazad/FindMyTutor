...
function PageHeader({
  ...
  return (
    <section
      className={cn(
        "mx-auto flex max-w-[980px] flex-col items-center gap-2 py-4 md:py-6 md:pb-8 lg:py-12 lg:pb-10",
        className,
      )}
      {...props}
    >
...
function PageHeaderDescription({
  ...
  return (
    <Balance
      className={cn(
        "max-w-[1000px] text-center text-lg text-muted-foreground sm:text-xl",
        className,
      )}
      {...props}
    />
